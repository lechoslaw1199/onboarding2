    ...
    <div className="w-full flex flex-col items-center min-h-screen relative overflow-x-clip">
      ...
      >
        ...
        <h1 className="text-[24px] font-bold text-[#221750] text-start leading-tight mb-6 px-4">
          {getPossessiveCap()} next step is <span className="text-black">blending sounds into simple words</span>
        </h1>

        <div className="text-[16px] text-start text-black font-normal mb-4 px-2 leading-relaxed">
          In the first lessons, your child will learn how to <span className="font-bold">blend letter sounds together to spell and write simple words</span> ("blending"), with the support of our Spelling Words module.
        </div>
