...
export default function FirstTimer() {
  ...
  const isReady = useImagePreload("/practice.jpeg");
    ...
    <div className="w-full flex flex-col items-center min-h-screen relative overflow-x-clip">
      ...
      >
        ...
        <div className="text-[16px] text-start text-black font-normal mb-4 px-2 leading-relaxed">
          In the first sessions, your child will learn how to recognize letters and the sound they make to <span className="font-bold">build a strong foundation.</span> Our tracing and phonics games will ensure your child is ready for the next steps.
        </div>
