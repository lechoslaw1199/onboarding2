  ...
  return (
    <div className="w-full flex flex-col items-center bg-white min-h-screen relative overflow-x-clip">
      ...
      <motion.main
        ...
        exit="exit"
        className="w-full max-w-[480px] px-8 flex flex-col items-start flex-grow pb-32"
      >
        ...
        <h1 className="text-[24px] font-bold text-[#221750] text-start leading-tight mb-8 px-4">
          Knowing letters & sounds is just one milestone in a clear, structured path toward confident writing and spelling
        </h1>
      </motion.main>
